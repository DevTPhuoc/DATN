...
<section class="banner-area organic-breadcrumb">
    ...
    <div class="product_image_area">
      ...
      width: '4830px' 
    }}><div class="owl-item cloned" style={{ width: '690px', marginRight: '0px' }}><div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p1.jpg" alt=""/>
						</div></div><div class="owl-item cloned" style={{ width: '690px', marginRight: '0px' }}><div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p1.jpg" alt=""/>
						</div></div><div class="owl-item active" style={{ width: '690px', marginRight: '0px' }}><div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p1.jpg" alt=""/>
						</div></div><div class="owl-item" style={{ width: '690px', marginRight: '0px' }}><div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p1.jpg" alt=""/>
						</div></div><div class="owl-item" style={{ width: '690px', marginRight: '0px' }}><div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p1.jpg" alt=""/>
						</div></div><div class="owl-item cloned" style={{ width: '690px', marginRight: '0px' }}><div class="single-prd-item">
